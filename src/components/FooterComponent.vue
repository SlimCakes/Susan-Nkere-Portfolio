<template>
  <div class="relative bg-[#DDb890] w-[1440px] min-h-[400px] flex flex-col justify-between">
    <!-- Social Media Icons -->
    ...
    <!-- Name Text -->
    <h1 class="text-white font-playfair text-[120px] leading-none tracking-wider">
      SUSAN NKERE
    </h1>
  </div>
</template>
